                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Chat met je data</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Stel je vraag of probeer een voorbeeld uit</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Stel hier je vraag / Posez votre question ici..."
                            disabled={isLoading}
